SuperRodFishingSlots::
	...
	db KINDLE_ROAD, TENTACOOL, 15, STARYU, 20, TENTACOOL, 30, TENTACRUEL, 30
	db ROUTE_22, POLIWAG, 5, POLIWAG, 10, POLIWAG, 15, POLIWHIRL, 15
	db ROUTE_23, POLIWAG, 25, POLIWAG, 30, POLIWHIRL, 30, POLIWHIRL, 40
	db CERULEAN_GYM, PSYDUCK, 15, GOLDEEN, 15, KRABBY, 15, STARYU, 15
	...
	db WILD_MEADOW, GOLDEEN, 30, SEAKING, 40, SEAKING, 50, SEAKING, 60
	db WATER_PATH, GOLDEEN, 30, SEAKING, 40, SEAKING, 50, SEAKING, 60
	db RUIN_VALLEY, GOLDEEN, 30, SEAKING, 40, SEAKING, 50, SEAKING, 60
	db -1 ; end
