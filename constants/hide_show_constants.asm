...
; TODO: mark sprite constants with an X that are never used
	...
	const HS_WILD_MEADOW_MASTER_BALL	   ; F2
	const HS_WILD_MEADOW_NUGGET			   ; F3
	const HS_WILD_MEADOW_TM15			   ; F4
	const HS_WATER_PATH_RARE_CANDY_1	   ; F5
	const HS_WATER_PATH_RARE_CANDY_2	   ; F6
	const HS_WATER_PATH_RARE_CANDY_3	   ; F7
	const HS_POKEMON_TEMPLE_MEW			   ; F8
